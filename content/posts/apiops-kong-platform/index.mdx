---
title: "Building a Multi-Region APIOps Platform with Gojira and Kong"
date: 2024-10-09
...
# Gojira: Build Multi-Region APIOps Platform with Kong

This project started as a requirement to solve the problem of maintaining multiple sources of truth for multiple Kong deployments, when all the Kong cluster essentially need to have parity in major components across services and routes across all Kong clusters in the same environment.
...
Hence, this document serves a project home for this piece of software/framework, or whatever it's supposed to be called.
